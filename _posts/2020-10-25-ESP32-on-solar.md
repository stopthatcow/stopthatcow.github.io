...
The [ESP32](https://en.wikipedia.org/wiki/ESP32) is a tiny, powerful, and inexpensive micro controller from Espressif. They have Wi-Fi and Bluetooth built in which makes them great for IoT projects. In this post I will talk about running an ESP32 on solar power. This post is not specific per-se to ESP32s and could be applied to any small 3v devices.
...
### Summary
I built the circuit and it works great. I've had it deployed for a few months now and in daylight it turns on about once an hour for about 4.5 minutes at a time. This runtime is achieved even without using any of the low power modes of the ESP32.
